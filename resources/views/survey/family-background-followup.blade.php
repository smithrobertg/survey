    ...
    <div>
        <fieldset class="form-group">
            ...
            <div class="form-group ml-4">
                ...
                <input class="form-control" type="text" name="reason_left_foster_care_other" id="reason-left-foster-care-other" placeholder="Other reason left foster care" />
            </div>
            <div class="form-group ml-3">
                <label class="form-label">If <strong><em>"Aged out"</em></strong> selected above...</label>
                ...
                <div class="form-group row ml-4">
                    <label>If <strong><em>"Yes"</em></strong>, did you? &nbsp;</label>
                    <div class="form-check form-check-inline has-success">
                        <label class="form-check-label">
        ...
        <fieldset class="form-group">
            <legend class="col-form-legend">If yes, how many placements were <strong><em>positive</em></strong>?</legend>
            <div class="form-check">
                <label class="form-check-label">
...
--}}
        ...
        <fieldset class="form-group">
            <legend class="col-form-legend">If yes, how many placements were <strong><em>negative</em></strong>?</legend>
            <div class="form-check">
                <label class="form-check-label">
