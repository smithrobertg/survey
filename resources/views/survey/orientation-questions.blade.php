...
-->
      <div class="form-group">
		...
		<div class="form-group">
			<label for="childhood_event_age_or_year">When did this childhood event happen? (Age <em>or</em> Year)</label>
		...
		<div class="form-group">
			<label for="adolescence_event_age_or_year">When did this adolescence event happen? (Age <em>or</em> Year)</label>
		...
		<div class="form-group">
			<label for="adulthood_event_age_or_year">When did this adulthood event happen? (Age <em>or</em> Year)</label>
...
@section('progress')
    @include('partials.progress-bar', ['progress' => '10'])
@endsection
