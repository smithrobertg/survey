...
class LifeEventsTableSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		seedFamilyBackgroundEvents();
		seedEducationLifeEvents();
    }

/*
	public function seedCategoryEvents()
	{
		$category = EventCategory::where('category', 'Category')->first();
		$field_name = "category_events[]";

		$category->life_events()->createMany([
			[ 'event' => "Event", 'prompt' => "Prompt", 'field_name' => $field_name ],
			[
				'event' => "Event",
				'prompt' => "Prompt",
...
*/
	...
	public function seedFamilyBackgroundEvents()
	{
	...
	public function seedEducationLifeEvents()
	{
